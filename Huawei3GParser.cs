          ...
          if (param != null)
          {
            ...
            for (int i = 0; i < param.Length; i++)
            {
              ...
              Huawei3GModelDto obj = new()
              {
                ...
                CellID = string.IsNullOrEmpty(_cellId) ? null : _cellId.Trim(),
                Cell = string.IsNullOrEmpty(_cell) ? null : _cell.Trim(),
                Site = string.IsNullOrEmpty(_site) ? null : _site.Trim(),
                Class = _class,
                Parameter = pvalue[0].Trim(),
                Value = pvalue[1].Trim(),
                TRX = null,
                index = _guid,
